...
import { Plus, Users, Globe, Edit2, Trash2, Key, Eye, Package } from 'lucide-react';
...
export function ApplicationsView({ applications, plans, onAdd, onEdit, onDelete, onViewUsers, onViewPlans }: ApplicationsViewProps) {
  const getAppPlans = (appId: string) => {
    return plans.filter(plan => plan.application_id === appId);
  };
