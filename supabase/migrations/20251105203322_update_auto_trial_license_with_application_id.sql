/*
  # Actualizar trigger de licencia de prueba para incluir application_id

  ## Descripción
  Actualiza la función `auto_assign_trial_license()` para incluir el campo
  `application_id` al crear licencias automáticamente. Esto corrige el error
  de columna faltante durante la sincronización de usuarios.

  ## Cambios
  1. Modifica el INSERT de licenses para incluir application_id
  2. El application_id se toma del NEW.application_id del usuario

  ## Notas
  - Mantiene toda la funcionalidad existente
  - Solo agrega el campo application_id al INSERT
*/

-- Actualizar función para incluir application_id
...
BEGIN
  ...
  IF v_plan_record IS NOT NULL THEN
    ...
    -- INSERT actualizado con application_id
